...
import { Ship, Star, TrendingUp, CreditCard } from 'lucide-react';
import { ShippingLineStats } from '@/types/agency';

interface ShippingLineSummaryCardsProps {
  stats: ShippingLineStats;
}

export function ShippingLineSummaryCards({ stats }: ShippingLineSummaryCardsProps) {
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Active shipping lines</p>
        </CardContent>
      </Card>
