...
const FEATURE_PERMISSION_MAP: Record<FeatureKey, (profile: UserProfile) => boolean> = {
  ...
  'dashboard.engineering': (p) => ['owner', 'director', 'marketing_manager', 'engineer', 'hse', 'marketing'].includes(p.role),
  ...
  'engineering.jmp.create': (p) => ['owner', 'director', 'marketing_manager', 'finance_manager', 'operations_manager', 'engineer', 'hse', 'marketing'].includes(p.role),
  'engineering.drawings.view': (p) => ['owner', 'director', 'marketing_manager', 'finance_manager', 'operations_manager', 'engineer', 'ops', 'hse', 'marketing'].includes(p.role),
  ...
  'engineering.assessments.view': (p) => ['owner', 'director', 'marketing_manager', 'finance_manager', 'operations_manager', 'engineer', 'hse', 'marketing'].includes(p.role),
  'engineering.assessments.create': (p) => ['owner', 'director', 'marketing_manager', 'finance_manager', 'operations_manager', 'engineer', 'hse', 'marketing'].includes(p.role),
